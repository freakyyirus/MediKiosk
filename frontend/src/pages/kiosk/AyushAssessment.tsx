...
function DoshaRing({ color, label, value }: { color: string; label: string; value: number }) {
  ...
  return (
    <div className="flex flex-col items-center text-center w-24">
      ...
      <span className="mt-2 font-bold text-surface-700" style={{ color }}>{label}</span>
    </div>
  );
}
    ...
    <div className="min-h-screen ayush-mode flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center max-w-3xl mx-auto w-full px-8 py-6">
        <div className="text-center animate-fade-in mb-6">
          ...
          <h1 className="text-4xl font-black bg-gradient-to-r from-primary-700 via-primary-600 to-accent-500 bg-clip-text text-transparent">
            Your Tridosha Profile
          </h1>
          <p className="text-lg text-surface-500 mt-3 max-w-xl mx-auto">
        ...
        <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
          ...
          <div className="card p-6 flex flex-col justify-center">
            ...
            <div className="mt-6 space-y-2">
              {DOSHAS.map((d) => (
                <div key={d.key} className="flex items-center gap-3 text-surface-700">
                  <span className="w-3 h-3 rounded-full" style={{ background: d.color }} />
                  <span className="font-semibold w-20">{d.label}</span>
        ...
        <div className="w-full card p-6 mb-6 animate-fade-in">
